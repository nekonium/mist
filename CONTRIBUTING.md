...
* What do you run? (_Binary version from [releases](https://github.com/nekonium/mist/releases) or a development version from the [commandline](https://github.com/nekonium/mist#run-mist)_)
