...
Template['popupWindows_sendTransactionConfirmation'].helpers({
    ...
    */
    'estimatedFee': function () {
        ...
        if (gas && this.gasPrice) {
            return EthTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000] unit', 'nuko');
        }
    },
    /**
    ...
    */
    'providedGas': function () {
        ...
        if (gas && this.gasPrice) {
            return EthTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000]', 'nuko');
        }
    },
    /**
